...
public class EntityHuman extends EntityHumanType {
    ...
    protected void initEntity() {
        ...
        if (!(this instanceof Player)) {
            ...
            this.uuid = Utils.dataToUUID(String.valueOf(this.getEntityId()).getBytes(StandardCharsets.UTF_8), this.getSkin()
    ...
    public void spawnTo(Player player) {
        if (this != player && !this.hasSpawned.containsKey(player.getLoaderId())) {
            ...
            if (this instanceof Player)
                this.server.updatePlayerListData(this.getUniqueId(), this.getEntityId(), this.getName(), this.skin, ((Player) this).getLoginChainData().getXUID(), new Player[]{player});
            else
                this.server.updatePlayerListData(this.getUniqueId(), this.getEntityId(), this.getName(), this.skin, new Player[]{player});
