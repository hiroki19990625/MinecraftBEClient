...
public class BlockSapling extends BlockFlowable {
    ...
    public boolean place(Item item, Block block, Block target, BlockFace face, double fx, double fy, double fz, Player player) {
        ...
        if (down.getBlockId() == Block.GRASS || down.getBlockId() == Block.DIRT || down.getBlockId() == Block.FARMLAND || down.getBlockId() == Block.PODZOL) {
    ...
    public boolean isSameType(Vector3 pos, int type) {
        ...
        return block.getBlockId() == this.getBlockId() && block.getDamage() == type;
    }
